...
output:
    rmarkdown::html_vignette:
        ...
        toc_depth: 3
vignette: >
  %\VignetteIndexEntry{cytobox examples}
...
available in `cytobox` for exploring single cell RNA-seq data
...
`cytobox` tells you if you try to plot genes which are undetected in the data:
```{r undetected}
